...
<Header/>
    <section class="hero">
        ...
        <Image src="/assets/webcam.png" width={300} height={370} alt="Webcam" />
    </section>
    ...
    <section class="explore-section">
        ...
        <div class="resources">
            <div class="resource-item">
                <Image src="/assets/signA.png" width={20} height={41} alt="Hand sign of letter A" />
            ...
            <div class="resource-item">
                <Image src="/assets/signC.png" width={41} height={43} alt="Hand sign of letter C" />
            ...
            <div class="resource-item">
                <Image src="/assets/signD.png" width={41} height={55} alt="Hand sign of letter D" />
                <h3>NAD.org</h3>
