    ...
    <div className="about-container">
      ...
      <style jsx global>{`
        * {
        ...
        /* Create a new row with centered content */
        .team-grid .team-card:nth-last-child(-n+2) {
          grid-row: 2;  /* Force them onto a new row */
        }

        /* Position Andres in the middle column */
        .team-grid .team-card:nth-last-child(2) {
          grid-column: 1 / 2;
          justify-self: end;
        }

        /* Position Karen in the third column */
        .team-grid .team-card:nth-last-child(1) {
          grid-column: 2 / 3;
          justify-self: start;
        }
